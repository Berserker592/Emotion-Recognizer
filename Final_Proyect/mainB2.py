...
async def home():
    ...
    <html>
        <head>
            ...
            <script>
                ...
                function saveAnalysis() {
                    fetch("http://127.0.0.1:8000/save-analysis/", { method: "POST" })
        ...
        <body>
            ...
            <button onclick="saveAnalysis()">Guardar</button>
            <button onclick="stopRecording()">Guardar Análisis 2</button>
...
async def save_analysis():
    ...
    if os.path.exists("videos/captured_video.webm"):
